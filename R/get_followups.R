...
#'
#' A function to retrieve the contact follow-up
#' data for a specific `outbreak_id`. This
#' function relies on the `/outbreaks/{id}/follow-ups`
...
#' greater, then we recommend using \code{\link{get_followups2}},
...
#'
#' @return
#' Returns a data frame of daily follow-ups of contacts. Some fields may require further unnesting. See the `tidyr::unnest()` function.
#' @export
#'
#' @examples
#' \dontrun{
