...
get_labresults <- function(url=url,
  ...
  if (method == "batches") {
    ...
    api_call_n <- paste0(url, "api/outbreaks/",outbreak_id,"/lab-results/aggregate-filtered-count")
    api_call_get <- paste0(url, "api/outbreaks/",outbreak_id,"/lab-results/aggregate")
    ...
    api_call_request <- paste0(url,"api/outbreaks/",outbreak_id,"/lab-results/export")
