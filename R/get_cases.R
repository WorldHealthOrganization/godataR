...
#' on the `/outbreaks/{id}/cases` API endpoint.
...
#' greater, then we recommend using \code{\link{get_cases2}},
...
#'
#' @return
#' Returns a data frame of cases. Some fields, such as addresses, hospitalization history, and questionnaire fields will require further unnesting. See the `tidyr::unnest()` function.
#' @export
#'
#' @examples
#' \dontrun{
