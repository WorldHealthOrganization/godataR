#' Download contacts-of-contacts from Go.Data (version 2.38.1 or later)
#'
#' A function to retrieve the contact-of-contact
#' data for a specific `outbreak_id`. This
#' function relies on the `/outbreaks/{id}/contacts-of-contacts/export`
#' API endpoint.
#'
...
#'
#' @return
#' Returns a data frame of contacts-of-contacts.
#' @export
#' @examples
#' \dontrun{
...
#'
#' contacts_of_contacts <- get_contacts_of_contacts2(url=url,
#'                                                   username=username,
#'                                                   password=password,
...
get_contacts_of_contacts2 <- function(url=url,
                                      username=username,
                                      password=password,
                                      outbreak_id=outbreak_id,
                                      wait=5,
  ...
  if (file.type=="json") {
    request_id <- GET(paste0(url,"api/outbreaks/",outbreak_id,"/contacts-of-contacts/export",
