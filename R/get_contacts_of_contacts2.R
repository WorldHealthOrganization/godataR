...
get_contacts_of_contacts2 <- function(url=url, username=username, password=password, outbreak_id=outbreak_id, wait=5, include.cases=FALSE) {
  ...
  export.request <- GET(paste0(url,"api/outbreaks/",outbreak_id,"/contacts-of-contacts/export",
