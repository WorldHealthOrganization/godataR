...
#'    Go.Data. This method relies on the GET outbreak/{id}/relationships
...
#'    outbreak/{id}/relationships/export API endpoint. An export
...
get_relationships <- function(url=url,
  ...
  if (method == "batches") {
    ...
    api_call_n <- paste0(url, "api/outbreaks/",outbreak_id,"/relationships/count")
    api_call_get <- paste0(url, "api/outbreaks/",outbreak_id,"/relationships")
    ...
    api_call_request <- paste0(url,"api/outbreaks/",outbreak_id,"/relationships/export")
