#' Download events from Go.Data (version 2.38.1 or later)
#'
#' A function to retrieve the event data for a
#' specific `outbreak_id`. This function relies
#' on the `/outbreaks/{id}/events/export`
#' API endpoint.
#'
